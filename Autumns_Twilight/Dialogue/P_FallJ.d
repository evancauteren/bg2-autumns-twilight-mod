...
@10014006 /* ~¡El día de tu juicio ha llegado, dragón! ¡¡¡Prepárate a sentir nuestra ira!!!~ */ DO ~ActionOverride("firmag01",Enemy()) ActionOverride("FIRKRA02",Enemy())~
...
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010017 /* ¡Bastardo! Asesinar a los desamparados... por un... ¿cruel experimento? */
END
...
//== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010019 /* (susurro) <CHARNAME>, claramente fuimos nosotros los que irrumpimos en su casa y matamos a esas viles criaturas. No es que me esté quejando, pero creo que aquí hay gato encerrado... Debemos estar atentos. */
//END
...
//== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010022 /* Claramente, esta es una Cofradía de Zopencos, <CHARNAME>. ¿Asesinar por este... este tipejo de rojo? (suspiro) Creo que puedo encargarme de ello, si es necesario. */
//END
...
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010029 /* ¿Conoceremos a uno de los mandamás de Athkatla? Vaya, nunca me imaginé llegar a esto cuando arribé a la ciudad... */
END

// Faldorn (Jaheira)
I_C_T CERNDJ 69 P_FallCEFALDOR9
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010030 /* ¡Faldorn debe caer! Estoy segura de que tú puedes con ella, Cernd. */
END

// Faldorn (Cernd)
I_C_T JAHEIRAJ 94 P_FallCEFALDOR10
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010031 /* ¡Faldorn debe caer! Estoy segura de que tú puedes con ella, Jaheira. */
END
...
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010033 /* ¡Abominación! Finalemente la justicia te ha alcanzado. ¡Caerás por tus crímenes! */
END
...
// == P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ // THEN @10010038 /* ¡Tus crímenes acaban aquí, malvado dragón! Como representante de Imnescar, daré //lo mejor de mí en la batalla. */ DO ~ActionOverride("firmag01",Enemy()) //ActionOverride("FIRKRA02",Enemy())~
// END
...
//== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010040 /* Todo apunta a un enfrentamiento definitivo con la criatura, ¿verdad? No veo las horas de armar un alboroto entre los muertos. */
//END

// Bodhi 1er combate en las catacumbas
I_C_T BODHI2 4 P_FallBODHI24
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010041 /* Estás acorralada y te atreves a insultarnos. ¡Estás a un paso de ser destruida, vampiresa!  */
END

// Traición de Yoshimo
I_C_T YOSHJ 113 P_FallYOSHJ113
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010042 /* ¿Q-qué? ¿Yo-yoshimo? No puede ser cierto... No... */
END
...
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010044 /* Contar con la alianza de los hechiceros torturados ha sido la decisión correcta, <CHARNAME>. Así, tendremos una oportunidad de derrotar a Irenicus. */
END
...
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010046 /* ¿Es sabio confiar en la palabra de este rey loco? ¡Es muy probable que se olvide de que nos conoce e intente comernos! */
END

// Svirneblin en la entrada de la ciudad svirneblin
//I_C_T UDSVIR01 3 P_FallUDSVIR013
//== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010047 /* He leído sobre los svirfneblin. En general, son criaturas benévolas. Si necesitan de nuestra ayuda, no deberíamos dudarlo, <CHARNAME>. Puede que incluso en este lugar podamos hacer algo de bien. */
//END

// CHARNAME decide traicionar a los svirneblin
I_C_T UDSVIR03 27 P_Fall_SVIRN1
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010048 /* ¡Por los viñedos de Imnescar! <CHARNAME>, tal traición es imperdonable... No... no puedo concebirlo... ¡Nuestros caminos llegan hasta aquí! Espero no verte nunca más... */
...
== P_FallJ IF ~InParty("P_Fall") Range("P_Fall",15) !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010047 /* ¡Ja! Has sido superado en número y en... ¿Q-qué? */
END
...
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010054 /* La batalla final ha llegado, Irenicus. Hemos viajado por incontables lugares para llegar a este momento. ¡Y habrás de devolver aquello que has arrebatado a <CHARNAME>! Prepárete. ¡Por Imnescar! */
END

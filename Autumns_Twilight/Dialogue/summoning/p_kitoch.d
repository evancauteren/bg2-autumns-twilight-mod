...
IF ~InParty("P_Fall")
See("P_Fall")
Global("P_FallAboutGormsDeath_KitAlive","GLOBAL",5)~ THEN BEGIN 73 // from:
  SAY @11100162 /* *ronroneo* He estado pensando, <CHARNAME>...~ */
  IF ~~ THEN DO ~SetGlobal("P_FallAboutGormsDeath_KitAlive","GLOBAL",6)~ GOTO 74
END
...
IF ~~ THEN BEGIN 77 // from:
  ...
  IF ~~ THEN DO ~SetGlobal("P_FallAboutGormsDeath_KitAlive","GLOBAL",6)~ EXIT
END
...
IF ~~ THEN BEGIN 80 // from:
  ...
  IF ~~ THEN DO ~SetGlobal("P_FallAboutGormsDeath_KitAlive","GLOBAL",6) SetGlobal("P_KitochiCHARNAME_CA_001","GLOBAL",1)~ EXIT
END

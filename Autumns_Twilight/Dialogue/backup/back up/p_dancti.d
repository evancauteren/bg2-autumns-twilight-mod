...
== p_dancti IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @4000 /* ~Ah, la Dama de las Bestias. Semielfa, para ti tengo esto: un artefacto forjado por los mismos selu'taar. Espero que te sea de utilidad.~ */  DO ~ CreateItem ("P_FITM1",1,1,0)  GiveItem("P_FITM1", "P_Fall") ~ 
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @4001 /* Gr-gracias, Danctian. Aún no sé cómo sentirme al respecto... sobre ti. Pero si Dusk y <CHARNAME> depositan su confianza en ti, yo también lo haré. */

...
~ THEN BEGIN 32 // from:
  SAY @10000033 /* ~Maestra de los Enjambres, tu poder es admirable. Defender a aquellos que no pueden defenderse es loable.~ */
  IF ~~ THEN DO ~SetGlobal("P_Bellfame_C0Paina1","GLOBAL",1)~ GOTO 31
END
...
// PaiNa Crossmod
I_C_T P_BELLD 30 P_Paina_Bellfame1
== C0PAINAJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @10000034 /* ~No busco alabanzas, ninfa. Hago lo correcto, hago lo que debo hacer.~ */
== p_belld IF ~~ THEN @10000035 /* Y haces lo que debes. Tu misión debe continuar, Pai'Na. Déjame ayudarte... */
== C0PAINAJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @10000036 /* ~¿Eh? ¿Qué haces con tus manos, ninfa? ¡Aléjate de mí!~ */
== p_belld IF ~~ THEN @10000037 /* Tranquila... deja que el poder fluya dentro de ti y acepta el obsequio de Mir. */
== C0PAINAJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @10000038 /* ~¿Mir? ¿De qué estás hablando? Siento... me siento un poco diferente. Como si pudiera... comandar nuevas criaturas.~ */
END

...
// Sirene crossmod
== C0SIRE2J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN @10000049 /* ~Toma sobre ti mi cansancio, Ilmater; yo tomaré sobre mí el dolor de mis enemigos si así salvo a los inocentes. ¡Tu Reinado llega a su fin, Morgrath! ¡En guardia!~ */

// SKITIA NPCS
== X3EMIJ IF ~InParty("X3Emi") InMyArea("X3Emi") !StateCheck("X3Emi",CD_STATE_NOTVALID)~ THEN @11100562 /* ~Estamos cerca de dejar este Abismo y para ello debemos matarte, Morgrath. ¡Que así sea!~ */
== X3HELJ IF ~InParty("X3Hel") InMyArea("X3Hel") !StateCheck("X3Hel",CD_STATE_NOTVALID)~ THEN @11100563 /* ~Haela me dará las fuerzas para aplastar a estos insectos. ¡Suerte en el acero, gloria en la sangre!~ */
== X3KALJ IF ~InParty("X3Kal") InMyArea("X3Kal") !StateCheck("X3Kal",CD_STATE_NOTVALID)~ THEN @11100564 /* ~¡Oy, arañas! No he llegado hasta aquí para ser devorado por ustedes. Ahora sentirán la furia del mediano. ¡Muerte! ~ */
== X3REBJ IF ~InParty("X3Reb") InMyArea("X3Reb") !StateCheck("X3Reb",CD_STATE_NOTVALID)~ THEN @11100565 /* ~Ansío volver a la superficie y este demonio es todo lo que evita que eso pase. Es hora de dejar todo en este combate. ¡No perderemos! ~ */
== X3VIEJ IF ~InParty("X3Vie") InMyArea("X3Vie") !StateCheck("X3Vie",CD_STATE_NOTVALID)~ THEN @11100566 /* ~Has vivido más tiempo del que puedo calcular, Morgrath. ¡Todo para ser destruida por nosotros! No eres una Reina. Eres una alimaña. ¡Prepárate a ser destruida! ~ */

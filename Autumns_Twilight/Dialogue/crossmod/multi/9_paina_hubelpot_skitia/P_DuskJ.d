...
// Paina
== C0PainaJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @9079210 /* ~No entiendo a qué se deba este combate, pero no negaré alimento a mis protegidas. ¡Que mis arañas se den un festín con sus cadáveres!~ */
...
// SKITIA NPCS
== X3EMIJ IF ~InParty("X3Emi") InMyArea("X3Emi") !StateCheck("X3Emi",CD_STATE_NOTVALID)~ THEN @11100545 /* ~No importa si caímos en una trampa. Dusk, ve al frente y yo te cubriré con ataques a distancia. ¡Al final, venceremos! ~ */
== X3HELJ IF ~InParty("X3Hel") InMyArea("X3Hel") !StateCheck("X3Hel",CD_STATE_NOTVALID)~ THEN @11100546 /* ~¡Esto me gusta! Tener la desventaja en números nunca fue algo que me haya desanimado, al contrario, ¡hará que el combate sea más glorioso!~ */
== X3KALJ IF ~InParty("X3Kal") InMyArea("X3Kal") !StateCheck("X3Kal",CD_STATE_NOTVALID)~ THEN @11100547 /* ~Entonces... era obvio que ese hurón era una trampa, compañero. ~ */
== P_DuskJ IF ~InParty("X3Kal") InMyArea("X3Kal") !StateCheck("X3Kal",CD_STATE_NOTVALID)~ THEN @11100548 /* ~Kale, tu caíste tanto como yo en la trampa.~ */
== X3KALJ IF ~InParty("X3Kal") InMyArea("X3Kal") !StateCheck("X3Kal",CD_STATE_NOTVALID)~ THEN @11100549 /* ~Oye, sólo estaba haciendo una observación. Bueno, supongo que no queda otra que ensuciarse las manos. Venga, Dusk. ¡Al combate! ~ */
== X3REBJ IF ~InParty("X3Reb") InMyArea("X3Reb") !StateCheck("X3Reb",CD_STATE_NOTVALID)~ THEN @11100550 /* ~El desenlace de los Caballeros Dragones Púrpuras está a unas pocas páginas de finalizar. Dusk, démosle un buen final a tus compañeros caídos.~ */
== X3VIEJ IF ~InParty("X3Vie") InMyArea("X3Vie") !StateCheck("X3Vie",CD_STATE_NOTVALID)~ THEN @11100551 /* ~Ugh, no sólo nos has traído a una cueva horrible, sino que fue directo a una trampa llena de monstruos apestosos. Espero que seas capaz de compensarnos, Dusk, si es que salimos de ésta.~ */

END

//////////////////////////////////////////
////// ALABARZA FIGHT GOOD PATH //////////
//////////////////////////////////////////
...
// Paina
== C0PainaJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @9079209 /* *suspiro* Si bien podrían ser un buen manjar para mis protegidas, estas criaturas parece que sólo quieren estar en paz. Entiendo lo que es el deseo por la soledad, por lo que yo diría que no ataques, humano. */
...
// SKITIA NPCS
== X3EMIJ IF ~InParty("X3Emi") InMyArea("X3Emi") !StateCheck("X3Emi",CD_STATE_NOTVALID)~ THEN @11100552 /* ~Las Colinas Ventolanza están llenos de monstruos que han intentado atacarnos a primera de turno. Éstos no lo han hecho, Dusk. ~ */
== X3HELJ IF ~InParty("X3Hel") InMyArea("X3Hel") !StateCheck("X3Hel",CD_STATE_NOTVALID)~ THEN @11100553 /* ~¿En serio creer las palabras a esta semiorca es una opción? Haz lo que quieras, niñato. Pero ten en cuenta que siempre estoy dispuesta a presentar batalla a guerreros de Sothillis.~ */
== X3KALJ IF ~InParty("X3Kal") InMyArea("X3Kal") !StateCheck("X3Kal",CD_STATE_NOTVALID)~ THEN @11100554 /* ~Entonces... si no combatir es una opción, quizás debamos tomarla, compañero. ~ */
== X3REBJ IF ~InParty("X3Reb") InMyArea("X3Reb") !StateCheck("X3Reb",CD_STATE_NOTVALID)~ THEN @11100555 /* ~Algo me dice que dicen la verdad, Dusk. Quizás debamos escucharles. ~ */
== X3VIEJ IF ~InParty("X3Vie") InMyArea("X3Vie") !StateCheck("X3Vie",CD_STATE_NOTVALID)~ THEN @11100556 /* ~Ugh, ¿en serio crees que esta fea criatura no quiere destrozarnos? Está esperando a la mínima oportunidad para hacer que sus monstruos nos machaquen. Debemos atacarles antes de que ellos lo hagan con nosotros.~ */
END
...
== C0PainaJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @10000041 /* *resoplido* ¿Todo esto para complacer a este loquito? */
...
I_C_T P_DUSKJ 22 P_Dusk_NPC_Michelson_JOKES1d_7
== C0PainaJ IF ~InParty("C0Paina") InMyArea("C0Paina") !StateCheck("C0Paina",CD_STATE_NOTVALID)~ THEN @10000041 /* *resoplido* ¿Todo esto para complacer a este loquito? */
== SC#HubJ IF ~InParty("Hubelpot") InMyArea("Hubelpot") !StateCheck("Hubelpot",CD_STATE_NOTVALID)~ THEN @10000189 /*~¡Jaja! Ha sido muy bueno, <CHARNAME>. No esperaba que tuvieras tan buen sentido del humor. Esto amerita una buena merienda.~ */
== P_FallJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10104000 /* ¿El paladín se llama 'Nadie'? No le veo la gra-- Ah, ya entiendo. *ríe* Muy bueno, <CHARNAME>. */
== WILSONJ IF ~InParty("Wilson") InMyArea("Wilson") !StateCheck("Wilson",CD_STATE_NOTVALID)~ THEN @10103495 /* (Wilson mueve sus orejas, demostrando confusión ante el chiste de <CHARNAME>) */

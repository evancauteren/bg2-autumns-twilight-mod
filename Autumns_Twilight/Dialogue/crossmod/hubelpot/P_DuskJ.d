...
// Hubelpot Crossmod
== SC#HubJ IF ~InParty("Hubelpot") InMyArea("Hubelpot") !StateCheck("Hubelpot",CD_STATE_NOTVALID)~ THEN @10000187 /* ~Creo que más o menos puedo entender el malestar de Dusk. O sea, a él lo han dejado con el cabello blanco con todo este asunto de venganza o justicia. Ya quisiera yo tener ese problema, pero como verán a mí se me ha ido el cabello con el tiempo y las arduas jornadas en la granja. Ah, mejor espabilar pa'que esto se termine pronto.~ */
...
// Kalah Muerte
EXTEND_BOTTOM KALAH2 4
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_Kalah_DuskLead
END

EXTEND_BOTTOM KALAH2 4
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Kalah_FallLead
END

CHAIN P_DUSKJ P_DuskFall_Kalah_DuskLead
@10103378
...
CHAIN P_FALLJ P_DuskFall_Kalah_FallLead
@10010012 /* I feel... a bit of pity for the gnome. The mockery he received triggered all this madness... But... his actions do not justify it. */
END KALAH2 13
...
EXTEND_BOTTOM FIRKRA02 25
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_Firkraag_DuskLead
END

EXTEND_BOTTOM FIRKRA02 25
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Firkraag_FallLead
END

// Nota: Usamos "COPY_TRANS FIRKRA02 25" al final de la cadena. 
CHAIN P_DUSKJ P_DuskFall_Firkraag_DuskLead
@10120011 /* ¡El día de tu juicio ha llegado, dragón! ¡¡¡Prepárate a sentir nuestra ira!!! */
...
END COPY_TRANS FIRKRA02 25

CHAIN P_FALLJ P_DuskFall_Firkraag_FallLead
@729000 /* ¡Tus crímenes acaban aquí, malvado dragón! ... */
== P_ALENJ IF ~InParty("P_Alen") InMyArea("P_Alen") !StateCheck("P_Alen",CD_STATE_NOTVALID)~ THEN @93115 /* <CHARNAME>, procura que ninguno de sus ataques de fuego me toque, ¿sí? No estoy de humor para ser calcinado. */
== P_CHONJ IF ~InParty("P_Chon") InMyArea("P_Chon") !StateCheck("P_Chon",CD_STATE_NOTVALID)~ THEN @93015 /* Serás una criatura antigua, alado, pero mi estilo de combate también lo es. ¡Siente la furia de mis garras! ¡¡¡Shehad Ibahalii!!! */
END COPY_TRANS FIRKRA02 25
...
== P_DuskJ IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ THEN @10100008 /* No, Yoshimo... no... ¿cómo has podido vender tu alma a este ser desgraciado? Maldito seas, Yoshimo... maldito seas... */
END
...
== P_DuskJ IF ~InParty("P_Dusk") See("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ THEN @10100015 /* ¿Qué diantres fue eso? Te convertiste en una criatura sediente de sangre, totalmente enajenada de sus sentidos de juicio. <CHARNAME>, eso fue el avatar del Asesino, ¿no es así? Fue impresionante... y escalofriante al mismo tiempo. */
END
...
EXTEND_BOTTOM PLAYER1 15
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_LonkDead_DuskLead
END

EXTEND_BOTTOM PLAYER1 15
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_LonkDead_FallLead
END

// Usamos COPY_TRANS PLAYER1 15 para heredar automáticamente todas las 
// interjecciones de BioWare (Imoen, Jaheira, Viconia, etc.) y la secuencia de corte final.

CHAIN P_DUSKJ P_DuskFall_LonkDead_DuskLead
@10100016 /* No me sentiría muy a gusto con tantos hechiceros... */
...
END COPY_TRANS PLAYER1 15

CHAIN P_FALLJ P_DuskFall_LonkDead_FallLead
@10010044 /* Contar con la alianza de los hechiceros torturados... */
END COPY_TRANS PLAYER1 15

// Diálogo por el Árbol de la Vida

EXTEND_BOTTOM PLAYER1 33
IF ~ InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DuskTreeOfLife","GLOBAL",0) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ EXTERN PLAYER1 pl10
END
...
EXTEND_BOTTOM PLAYER1 33
IF ~ InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DuskTreeOfLife","GLOBAL",0) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ EXTERN PLAYER1 pl8
END
...
== P_DuskJ IF ~InParty("P_Dusk") Range("P_Dusk",15) !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ THEN @10100027 /* ¡Le hemos vencido! Pero... algo no está bien... ¿qué sucede? */
END
...
EXTEND_BOTTOM GAELAN 87
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_Gaelan_DuskLead
END

EXTEND_BOTTOM GAELAN 87
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Gaelan_FallLead
END

CHAIN P_DUSKJ P_DuskFall_Gaelan_DuskLead
@10120002 /* Finalmente... conoceremos al líder de los Ladrones de las Sombras. Más vale que haga valer nuestros esfuerzos... */
...
CHAIN P_FALLJ P_DuskFall_Gaelan_FallLead
@10010029 /* Are we going to meet one of the bigwigs of Athkatla? Wow, I never imagined I'd come to this when I arrived in the city... */
END GAELAN 66
...
== P_DuskJ IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ THEN @10100516 /* ¡Ja! ¿Cómo es posible que una drow se haya dejado atrapar tan fácilmente por estos alfeñiques? En mi opinión, tal ineptitud debería ser castigada con la muerte... */
END

// Xzar
EXTEND_BOTTOM LYROS 5
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_Dusk_Lyros_Good
END

EXTEND_BOTTOM LYROS 5
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_Dusk_Lyros_Evil
END

CHAIN P_DUSKJ P_Dusk_Lyros_Good
@10100061 /* (susurro) <CHARNAME>, claramente fuimos nosotros los que irrumpimos en su casa y matamos a esas viles criaturas. No es que me esté quejando, pero creo que aquí hay gato encerrado... Debemos estar atentos. */
END LYROS 23

CHAIN P_DUSKJ P_Dusk_Lyros_Evil
@10100517 /* (susurro) Esto es cómico... hemos sido nosotros los que aniquilamos a las 'pertenencias' de este infeliz. Si bien fue un placer hacerlo, creo que hemos sido engañados, <CHARNAME>. */
END LYROS 23


// --- INTERJECCIONES EN EL BOSQUE DE LOS DRUIDAS (CERND DESAFÍA A FALDORN) ---

EXTEND_BOTTOM CERNDJ 69
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_CerndFaldorn_DuskLead
END

EXTEND_BOTTOM CERNDJ 69
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(4) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID) !Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_FALLJ P_DuskFall_CerndFaldorn_FallLead
END

CHAIN P_DUSKJ P_DuskFall_CerndFaldorn_DuskLead
@10100062 /* Incluso yo puedo entender que esta Faldorn es una afrenta para la naturaleza. Usar a los animales para el asesinato por venganza es una maniobra soez y cobarde. Cernd, espero que puedas patearle el trasero. */
...
CHAIN P_FALLJ P_DuskFall_CerndFaldorn_FallLead
@10010030 /* Faldorn must fall! I'm sure you can handle her, Cernd. */
END CEFALDOR 11
...
EXTEND_BOTTOM JAHEIRAJ 94
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_JaheiraFaldorn_DuskLead
END

EXTEND_BOTTOM JAHEIRAJ 94
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(4) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID) !Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_FALLJ P_DuskFall_JaheiraFaldorn_FallLead
END

CHAIN P_DUSKJ P_DuskFall_JaheiraFaldorn_DuskLead
@10120003 /* Incluso yo puedo entender que esta Faldorn es una afrenta para la naturaleza. Usar a los animales para el asesinato por venganza es una maniobra soez y cobarde. Jaheira, espero que puedas patearle el trasero. */
...
CHAIN P_FALLJ P_DuskFall_JaheiraFaldorn_FallLead
@10010031 /* Faldorn must fall! I'm sure you can handle her, Jaheira. */
END CEFALDOR 12
...
EXTEND_BOTTOM BODHI2 4
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_BodhiCatacombs_DuskLead
END

EXTEND_BOTTOM BODHI2 4
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_BodhiCatacombs_FallLead
END

CHAIN P_DUSKJ P_DuskFall_BodhiCatacombs_DuskLead
@10100065 /* Mide tus palabras, criatura. Puede que <CHARNAME> sea un fastidio (sin ánimos de ofender) pero al menos tiene claridad en sus palabras, a diferencia tuya. */
...
CHAIN P_FALLJ P_DuskFall_BodhiCatacombs_FallLead
@10010041 /* You're cornered and you dare to insult us. You're one step away from being destroyed, vampire! */
END BODHI2 5


// --- CAPÍTULO 4: BODHI ANUNCIA LA CAZA EN SPELLHOLD (LABERINTO) ---

EXTEND_BOTTOM PPBODHI4 14
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_SpellholdBodhi_DuskLead_Good
END

EXTEND_BOTTOM PPBODHI4 14
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_SpellholdBodhi_DuskLead_Evil
END

EXTEND_BOTTOM PPBODHI4 14
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_SpellholdBodhi_FallLead
END

// Cadena cuando Dusk es Bueno
CHAIN P_DUSKJ P_DuskFall_SpellholdBodhi_DuskLead_Good
@10100066 /* Parece ser que Irenicus aún puede ser alcanzado. <CHARNAME>, debemos superar los obstáculos que nos ponga esta criatura si queremos lograrlo. */
...
// Cadena cuando Dusk es Malvado
CHAIN P_DUSKJ P_DuskFall_SpellholdBodhi_DuskLead_Evil
@10100519 /* Tenemos una oportunidad aquí, <CHARNAME>. Irenicus está cada vez más cerca. Aunque no me fío de este... demonio. Hagamos lo que quiere y luego... 'lidiemos' con ella. */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010043 /* Si Bodhi hará esto, es porque tiene un sinfín de trampas plantadas para nosotros. ¡Podría dispararle desde aquí! Pero... no sé si eso funcionaría... */
END PPBODHI4 15

// Cadena cuando solo está Fall
CHAIN P_FALLJ P_DuskFall_SpellholdBodhi_FallLead
@10010043 /* Si Bodhi hará esto, es porque tiene un sinfín de trampas plantadas para nosotros. ¡Podría dispararle desde aquí! Pero... no sé si eso funcionaría... */
END PPBODHI4 15
...
EXTEND_BOTTOM RIFTM01 28
  IF ~InParty("P_Alen") InMyArea("P_Alen") !StateCheck("P_Alen",CD_STATE_NOTVALID)~ 
  EXTERN P_ALENJ P_DuskFall_Riftm_AlenLead
END

EXTEND_BOTTOM RIFTM01 28
  IF ~InParty("P_Chon") InMyArea("P_Chon") !StateCheck("P_Chon",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Alen") !InMyArea("P_Alen") StateCheck("P_Alen",CD_STATE_NOTVALID)~ 
  EXTERN P_CHONJ P_DuskFall_Riftm_ChonLead
END

EXTEND_BOTTOM RIFTM01 28
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)
      OR(3) !InParty("P_Alen") !InMyArea("P_Alen") StateCheck("P_Alen",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Chon") !InMyArea("P_Chon") StateCheck("P_Chon",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_Riftm_DuskLead_Good
END
...
EXTEND_BOTTOM RIFTM01 28
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)
      OR(3) !InParty("P_Alen") !InMyArea("P_Alen") StateCheck("P_Alen",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Chon") !InMyArea("P_Chon") StateCheck("P_Chon",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_Riftm_DuskLead_Evil
END
...
EXTEND_BOTTOM RIFTM01 28
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      ...
      OR(3) !InParty("P_Chon") !InMyArea("P_Chon") StateCheck("P_Chon",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Riftm_FallLead
END

// --- CADENAS DE DIÁLOGO ---

CHAIN P_ALENJ P_DuskFall_Riftm_AlenLead
@93113 /* Tantos sentimientos cobardes me abruman, <CHARNAME>. Quizás uno de mis Conos de Frío le hagan cambiar de parecer... */
...
CHAIN P_CHONJ P_DuskFall_Riftm_ChonLead
@93013 /* ¿Todos los elfos son así, <CHARNAME>? Esa lloradera no duraría mucho tiempo en el Abismo. */
== P_DUSKJ IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ THEN @10100072 /* El artefacto no nos pertenece. <CHARNAME> está haciendo lo correcto, al menos deberías darle el beneficio de la duda. */
== P_DUSKJ IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ THEN @10103387 /* ¡Escúchame bien, alfeñique! <CHARNAME> ha decidido regresar el artefacto porque ha creído que es lo correcto... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010034 /* He conocido a elfos testarudos... y ellos viven por siglos. ¡Pero nunca vi a una criatura tan testaruda como tú! */
END RIFTM01 29

CHAIN P_DUSKJ P_DuskFall_Riftm_DuskLead_Good
@10100072 /* El artefacto no nos pertenece. <CHARNAME> está haciendo lo correcto, al menos deberías darle el beneficio de la duda. */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010034 /* He conocido a elfos testarudos... y ellos viven por siglos. ¡Pero nunca vi a una criatura tan testaruda como tú! */
END RIFTM01 29

CHAIN P_DUSKJ P_DuskFall_Riftm_DuskLead_Evil
@10103387 /* ¡Escúchame bien, alfeñique! <CHARNAME> ha decidido regresar el artefacto porque ha creído que es lo correcto... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010034 /* He conocido a elfos testarudos... y ellos viven por siglos. ¡Pero nunca vi a una criatura tan testaruda como tú! */
END RIFTM01 29

CHAIN P_FALLJ P_DuskFall_Riftm_FallLead
@10010034 /* He conocido a elfos testarudos... y ellos viven por siglos. ¡Pero nunca vi a una criatura tan testaruda como tú! */
END RIFTM01 29
...
EXTEND_BOTTOM MAEVAR 24
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_Maevar_DuskLead
END

EXTEND_BOTTOM MAEVAR 24
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Maevar_FallLead
END

CHAIN P_DUSKJ P_DuskFall_Maevar_DuskLead
@10100073 /* Este tipo es un pelmazo, <CHARNAME>. Sin duda espero que nuestros esfuerzos valgan la pena. */
...
CHAIN P_FALLJ P_DuskFall_Maevar_FallLead
@10010021 /* Definitivamente este es el más desagradable de los ladrones que he conocido. */
== YOSHJ IF ~InParty("Yoshimo") InMyArea("Yoshimo") !StateCheck("Yoshimo",CD_STATE_NOTVALID)~ THEN @10010023 /* Pues, corríjame si me equivoco, lady Fall, pero no me parece que haya conocido a muchos. */
== P_FALLJ IF ~InParty("Yoshimo") InMyArea("Yoshimo") !StateCheck("Yoshimo",CD_STATE_NOTVALID)~ THEN @10010024 /* Hm... buen punto, Yoshimo. Aún así, mantengo mi postura. */
END MAEVAR 25
...
EXTEND_BOTTOM MAEVAR 29
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_MaevarTraitor_DuskLead_Good
END

EXTEND_BOTTOM MAEVAR 29
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_MaevarTraitor_DuskLead_Evil
END

EXTEND_BOTTOM MAEVAR 29
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_MaevarTraitor_FallLead
END

// Cadena cuando Dusk es Bueno
CHAIN P_DUSKJ P_DuskFall_MaevarTraitor_DuskLead_Good
@10100074 /* Si hay algo que me gustaría evitar, es asesinar en nombre de este idiota, <CHARNAME>. Espero que puedas encontrar la sabiduría de hacer lo correcto. */
...
// Cadena cuando Dusk es Malvado
CHAIN P_DUSKJ P_DuskFall_MaevarTraitor_DuskLead_Evil
@10103381 /* No es que me queje en tener que asesinar a un ladrón, <CHARNAME>. Pero preferiría tener que hacerlo por motivos propios y no por necesidad de esta lacra... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010025 /* ¿Tenemos que seguir asesinando gente, encima por este maníatico? <CHARNAME>, esto se torna cada vez peor. */
END MAEVAR 30

// Cadena cuando solo está Fall
CHAIN P_FALLJ P_DuskFall_MaevarTraitor_FallLead
@10010025 /* ¿Tenemos que seguir asesinando gente, encima por este maníatico? <CHARNAME>, esto se torna cada vez peor. */
END MAEVAR 30
...
EXTEND_BOTTOM RENAL 5
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_RenalIntro_DuskLead
END

EXTEND_BOTTOM RENAL 5
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_RenalIntro_FallLead
END

CHAIN P_DUSKJ P_DuskFall_RenalIntro_DuskLead
@10100077 /* Es bastante carismático para ser un ladrón. Veremos qué tiene para decir... */
...
CHAIN P_FALLJ P_DuskFall_RenalIntro_FallLead
@10010020 /* Sonríe demasiado como para que ello inspire confianza. */
END RENAL 7

// --- RENAL RECIBE LAS PRUEBAS CONTRA MAE'VAR (ORDEN DE ASESINATO) ---

EXTEND_BOTTOM RENAL 41
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_RenalMaevarDeath_DuskLead_Good
END

EXTEND_BOTTOM RENAL 41
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_RenalMaevarDeath_DuskLead_Evil
END

EXTEND_BOTTOM RENAL 41
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_RenalMaevarDeath_FallLead
END

// Cadena cuando Dusk es Bueno
CHAIN P_DUSKJ P_DuskFall_RenalMaevarDeath_DuskLead_Good
@10100078 /* Finalmente, alguien a quien vale la pena matar. Quizás te sorprenda lo que voy a decir, pero espero que nos asignen la tarea de matar a ese bastardo. */
...
// Cadena cuando Dusk es Malvado
CHAIN P_DUSKJ P_DuskFall_RenalMaevarDeath_DuskLead_Evil
@10100523 /* Espero que nos encarguen el asesinato de Mae'var, <CHARNAME>. Esa lacra no merece estar con vida un segundo más... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010026 /* Esto sonará extraño, pero no oirás quejas de mi parte en tener que matar a ese mentecato. */
END RENAL 43

// Cadena cuando solo está Fall
CHAIN P_FALLJ P_DuskFall_RenalMaevarDeath_FallLead
@10010026 /* Esto sonará extraño, pero no oirás quejas de mi parte en tener que matar a ese mentecato. */
END RENAL 43
...
EXTEND_BOTTOM ARAN 49
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_AranLinvail_DuskLead
END

EXTEND_BOTTOM ARAN 49
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_AranLinvail_FallLead
END

// Usamos COPY_TRANS para heredar a Korgan, Keldorn, Jaheira, Minsc, Haer'Dalis y Hexxat.
CHAIN P_DUSKJ P_DuskFall_AranLinvail_DuskLead
@10100079 /* Este tipo es tan carismático como Renal. Sin embargo, no puedo evitar pensar que puede que estemos siendo estafados... */
...
END COPY_TRANS ARAN 49

CHAIN P_FALLJ P_DuskFall_AranLinvail_FallLead
@10010039 /* Para ser un líder ladrón, tiene mucho de político. Difícilmente le cuesta mantener una promesa. */
END COPY_TRANS ARAN 49
...
EXTEND_BOTTOM HENDAK 41
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_Hendak_DuskLead_Good
END

EXTEND_BOTTOM HENDAK 41
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_Hendak_DuskLead_Evil
END

EXTEND_BOTTOM HENDAK 41
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Hendak_FallLead
END

// Cadena cuando Dusk es Bueno
CHAIN P_DUSKJ P_DuskFall_Hendak_DuskLead_Good
@10100085 /* La esclavitud es un negocio muy redituable. El precio que pagamos por la libertad no es visible, pero cuesta y mucho. Acabar con los asquerosos esclavistas es lo mejor que podemos hacer. */
...
// Cadena cuando Dusk es Malvado
CHAIN P_DUSKJ P_DuskFall_Hendak_DuskLead_Evil
@10100525 /* La esclavitud es un negocio muy redituable. Pero es un negocio de cobardes. Y no hay nada que me dé más placer que acabar con cobardes que se creen fuertes. Vamos, <CHARNAME>. Busquemos esa guarida y armemos algo de alboroto. */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010015 /* Tenemos más trabajo por hacer. Nunca creí que tendría la oportunidad de hacer el bien de esta manera cuando llegué a Athkatla, <CHARNAME>. Será un honor pelear a tu lado. */
END HENDAK 18

// Cadena cuando solo está Fall
CHAIN P_FALLJ P_DuskFall_Hendak_FallLead
@10010015 /* Tenemos más trabajo por hacer. Nunca creí que tendría la oportunidad de hacer el bien de esta manera cuando llegué a Athkatla, <CHARNAME>. Será un honor pelear a tu lado. */
END HENDAK 18

// --- HENDAK AGRADECE LA LIBERACIÓN DE LOS ESCLAVOS (MISIÓN FINALIZADA) ---

EXTEND_BOTTOM HENDAK 43
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_HendakEnd_DuskLead_Good
END

EXTEND_BOTTOM HENDAK 43
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_HendakEnd_DuskLead_Evil
END

EXTEND_BOTTOM HENDAK 43
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_HendakEnd_FallLead
END

// Cadena cuando Dusk es Bueno
CHAIN P_DUSKJ P_DuskFall_HendakEnd_DuskLead_Good
@10100086 /* Hemos hecho algo bueno aquí, <CHARNAME>. Estoy seguro de que Hendak hará lo posible para mejorar la calidad de vida de aquellos que fueron esclavos. */
...
// Cadena cuando Dusk es Malvado
CHAIN P_DUSKJ P_DuskFall_HendakEnd_DuskLead_Evil
@10100526 /* No creo que la 'recompensa' haya valido la pena. Pero bueno, destrozar a esos pusilánimes ha sido todo un placer. */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010016 /* Bueno, espero que Hendak se encargue de que algo así no vuelva a surgir. */
END HENDAK 32

// Cadena cuando solo está Fall
CHAIN P_FALLJ P_DuskFall_HendakEnd_FallLead
@10010016 /* Bueno, espero que Hendak se encargue de que algo así no vuelva a surgir. */
END HENDAK 32
...
== P_DuskJ IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ THEN @10100088 /* Así que lo admites... Miserable. Pagarás por lo que has hecho... */
END

I_C_T TANNER 8 P_DuskTanner82
== P_DuskJ IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ THEN @10100528 /* Debo admitir que me pica un poco la curiosidad de por qué ha hecho todo esto. Pero, de nuevo, ¿a quién le importa el deseo de un chiflado? */
END
...
EXTEND_BOTTOM UHOGRE01 5
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_Madulf_DuskLead
END

EXTEND_BOTTOM UHOGRE01 5
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(4) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID) !Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_FALLJ P_DuskFall_Madulf_FallLead
END

CHAIN P_DUSKJ P_DuskFall_Madulf_DuskLead
@10100096 /* No me pinta que ellos sean los responsables de este misterio, <CHARNAME>. Cazarlos sin que hayan hecho nada malo sería un error. Creo que es mejor que sigamos indagando. */
...
CHAIN P_FALLJ P_DuskFall_Madulf_FallLead
@10010036 /* Es verdad que mi voz no es de la experiencia, <CHARNAME>. Pero no creo que estos ogros sean los responsables de lo que sucede aquí. */
END UHOGRE01 6
...
EXTEND_BOTTOM FIRKRA02 21
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_FirkraagDelay_DuskLead
END

EXTEND_BOTTOM FIRKRA02 21
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_FirkraagDelay_FallLead
END

EXTEND_BOTTOM FIRKRA02 21
  IF ~InParty("P_Alen") InMyArea("P_Alen") !StateCheck("P_Alen",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Fall") !InMyArea("P_Fall") StateCheck("P_Fall",CD_STATE_NOTVALID)~ 
  EXTERN P_ALENJ P_DuskFall_FirkraagDelay_AlenLead
END
...
EXTEND_BOTTOM FIRKRA02 21
  IF ~InParty("P_Chon") InMyArea("P_Chon") !StateCheck("P_Chon",CD_STATE_NOTVALID)
      ...
      OR(3) !InParty("P_Fall") !InMyArea("P_Fall") StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Alen") !InMyArea("P_Alen") StateCheck("P_Alen",CD_STATE_NOTVALID)~ 
  EXTERN P_CHONJ P_DuskFall_FirkraagDelay_ChonLead
END

// --- CADENAS DE DIÁLOGO (HEREDAN LAS SALIDAS ORIGINALES) ---

CHAIN P_DUSKJ P_DuskFall_FirkraagDelay_DuskLead
@10120010 /* Una criatura imponente... Dicen que los dragones ancianos se encuentran entre las criaturas más poderosas de los Reinos... Creo que es oportuno que posterguemos este combate... Creo... */
...
END COPY_TRANS FIRKRA02 21

CHAIN P_FALLJ P_DuskFall_FirkraagDelay_FallLead
@10010037 /* Nunca... nunca creí que me sentiría tan feliz de huir de una batalla... */
== P_ALENJ IF ~InParty("P_Alen") InMyArea("P_Alen") !StateCheck("P_Alen",CD_STATE_NOTVALID)~ THEN @93114
== P_CHONJ IF ~InParty("P_Chon") InMyArea("P_Chon") !StateCheck("P_Chon",CD_STATE_NOTVALID)~ THEN @93014
END COPY_TRANS FIRKRA02 21

CHAIN P_ALENJ P_DuskFall_FirkraagDelay_AlenLead
@93114 /* Una decisión inteligente, <CHARNAME>. La verdad no estaba de humor... */
== P_CHONJ IF ~InParty("P_Chon") InMyArea("P_Chon") !StateCheck("P_Chon",CD_STATE_NOTVALID)~ THEN @93014
END COPY_TRANS FIRKRA02 21

CHAIN P_CHONJ P_DuskFall_FirkraagDelay_ChonLead
@93014 /* La criatura es... imponente. No estoy de acuerdo con huir... */
END COPY_TRANS FIRKRA02 21


// --- CASTILLO DE'ARNISE: NALIA SE OFRECE A UNIRSE AL GRUPO ---

EXTEND_BOTTOM NALIA 56
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_NaliaIntro_DuskLead
END

EXTEND_BOTTOM NALIA 56
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_NaliaIntro_FallLead
END

CHAIN P_DUSKJ P_DuskFall_NaliaIntro_DuskLead
@10100099 /* La muchacha no carece de coraje, <CHARNAME>. Creo que sería una buena adición al grupo. Sin embargo, también comprendería que decidas no arriesgar su cuello en esta empresa. */
...
CHAIN P_FALLJ P_DuskFall_NaliaIntro_FallLead
@10010013 /* Tiene un espíritu combativo. Eso me gusta. Creo que sería una buena camarada. */
END NALIA 108
...
EXTEND_BOTTOM PPSAEM3 2
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_SaemonBrynnlaw_DuskLead
END

EXTEND_BOTTOM PPSAEM3 2
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_SaemonBrynnlaw_FallLead
END

CHAIN P_DUSKJ P_DuskFall_SaemonBrynnlaw_DuskLead
@10100108 /* De tres palabras que dice este tipo, cuatro son mentiras. Sin embargo, <CHARNAME>, (pese a arriesgarnos a ser nuevamente traicionados por este batracio) creo que deberíamos escucharlo. */
...
CHAIN P_FALLJ P_DuskFall_SaemonBrynnlaw_FallLead
@10010045 /* ¿Otra vez intentas engañarnos? Déjame enviar a Daren para que muerda su trasero, <CHARNAME>, por favor. */
END PPSAEM3 10
...
EXTEND_BOTTOM SAHKNG01 33
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_SahKing_DuskLead
END

EXTEND_BOTTOM SAHKNG01 33
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_SahKing_FallLead
END

// --- CADENAS DE DIÁLOGO ---

CHAIN P_DUSKJ P_DuskFall_SahKing_DuskLead
@10100116 /* Ciertamente, este hombre-pez es muy cabeza dura. Me recuerda a alguien... */
== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @10120026 /* Bubú pregunta... */
== P_DUSKJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @10120027 /* (carraspeo) Oh, no, mi querido Minsc... */
== MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @10120028 /* ¿Munsc? ¡Qué gran nombre!... */
== P_DUSKJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @10120029 /* De los mejores. */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010046
END COPY_TRANS SAHKNG01 33

CHAIN P_FALLJ P_DuskFall_SahKing_FallLead
@10010046 /* ¿Es sabio confiar en la palabra de este rey loco? ... */
END COPY_TRANS SAHKNG01 33
...
EXTEND_BOTTOM UDSILVER 9
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_Adalon_DuskLead_Good
END

EXTEND_BOTTOM UDSILVER 9
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_Adalon_DuskLead_Evil
END

EXTEND_BOTTOM UDSILVER 9
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(2) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Adalon_FallLead
END

// --- CADENAS DE DIÁLOGO ---

CHAIN P_DUSKJ P_DuskFall_Adalon_DuskLead_Good
@10100121 /* Aún no salgo de mi asombro. Esta dragona es sumamente hermosa... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010049
END COPY_TRANS UDSILVER 9

CHAIN P_DUSKJ P_DuskFall_Adalon_DuskLead_Evil
@10100531 /* Nunca creí ver a un dragón plateado... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010049
END COPY_TRANS UDSILVER 9

CHAIN P_FALLJ P_DuskFall_Adalon_FallLead
@10010049 /* *traga saliva* ¿Existen criaturas tan bellas en la Infraoscuridad? Espléndido... */
END COPY_TRANS UDSILVER 9

// --- INFRAOSCURIDAD: ADALON TRANSFORMA AL GRUPO EN DROWS (ILUSIÓN) ---

EXTEND_BOTTOM UDSILVER 35
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_DUSKJ P_DuskFall_AdalonDrow_DuskLead
END

EXTEND_BOTTOM UDSILVER 35
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(3) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_AdalonDrow_FallLead
END

CHAIN P_DUSKJ P_DuskFall_AdalonDrow_DuskLead
@10100122 /* Rayos... nunca creí que algún día habría de convertirme en un... drow... */
== AERIEJ IF ~InParty("Aerie") InMyArea("Aerie") !StateCheck("Aerie",CD_STATE_NOTVALID)~ THEN @10120035 /* N-no te ves tan mal, Dusk. No pongas esa cara. A fin de cuentas, así es como lucirías si hubieses nacido como un elfo. U-uno de piel oscura. */
== P_DUSKJ IF ~InParty("Aerie") InMyArea("Aerie") !StateCheck("Aerie",CD_STATE_NOTVALID)~ THEN @10120036 /* Sí, bueno... tú no has cambiado mucho. Sólo tu tono de piel se ha oscurecido, pero con claridad aún puedo ver que eres Aerie. */
== P_DUSKJ IF ~InParty("Aerie") InMyArea("Aerie") !StateCheck("Aerie",CD_STATE_NOTVALID) InParty("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN @10120037 /* Hasta puedo ver que tienes un parecido a Viconia, je. */
== VICONIJ IF ~InParty("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID) InParty("Aerie") InMyArea("Aerie") !StateCheck("Aerie",CD_STATE_NOTVALID)~ THEN @10120038 /* Escuché eso, rivvil. Tus bromas pueden costarte caro. */
== AERIEJ IF ~InParty("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID) InParty("Aerie") InMyArea("Aerie") !StateCheck("Aerie",CD_STATE_NOTVALID)~ THEN @10120039 /* En esta ocasión estoy de acuerdo con Viconia. Dusk, retráctate. */
== P_DUSKJ IF ~InParty("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID) InParty("Aerie") InMyArea("Aerie") !StateCheck("Aerie",CD_STATE_NOTVALID)~ THEN @10120040 /* Bueno, bueno. Dejen de mirarme así. (suspiro) Creo que abro mucho la boca últimamente... */
...
CHAIN P_FALLJ P_DuskFall_AdalonDrow_FallLead
@10010050 /* *refunfuñeo* Estaba más que bien con mi aspecto. Pero bueno, entiendo que debemos soportar esto por un bien mayor. */
END UDSILVER 36
...
EXTEND_BOTTOM TRSKIN02 16
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_Tiris_DuskLead_Good
END

EXTEND_BOTTOM TRSKIN02 16
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_Tiris_DuskLead_Evil
END

EXTEND_BOTTOM TRSKIN02 16
  IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)
      OR(2) !InParty("P_Dusk") !InMyArea("P_Dusk") StateCheck("P_Dusk",CD_STATE_NOTVALID)~ 
  EXTERN P_FALLJ P_DuskFall_Tiris_FallLead
END

// --- CADENAS DE DIÁLOGO ---

CHAIN P_DUSKJ P_DuskFall_Tiris_DuskLead_Good
@10103382 /* <CHARNAME>, aparentemente hemos dado con el curtidor... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010035
END COPY_TRANS TRSKIN02 16

CHAIN P_DUSKJ P_DuskFall_Tiris_DuskLead_Evil
@10103383 /* ¡Ja! ¿Quién lo diría? Hemos dado con el bastardo despellejador... */
== P_FALLJ IF ~InParty("P_Fall") InMyArea("P_Fall") !StateCheck("P_Fall",CD_STATE_NOTVALID)~ THEN @10010035
END COPY_TRANS TRSKIN02 16

CHAIN P_FALLJ P_DuskFall_Tiris_FallLead
@10010035 /* ¡Rejiek! Aquí en Caravasar... Es nuestra oportunidad de acabar lo que no pudimos en Athkatla. */
END COPY_TRANS TRSKIN02 16
...
EXTEND_BOTTOM SUJON 14
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",0)~ 
  EXTERN P_DUSKJ P_DuskFall_IrenicusFinal_DuskLead_Good
END

EXTEND_BOTTOM SUJON 14
  IF ~InParty("P_Dusk") InMyArea("P_Dusk") !StateCheck("P_Dusk",CD_STATE_NOTVALID) Global("P_DUSK_IS_EVIL","GLOBAL",1)~ 
  EXTERN P_DUSKJ P_DuskFall_IrenicusFinal_DuskLead_Evil
END

// Cadena cuando Dusk es Bueno/Neutral
CHAIN P_DUSKJ P_DuskFall_IrenicusFinal_DuskLead_Good
@10103442 /* Es hora de que pagues por lo que has hecho, Jon Irenicus. ¡Por la justicia de Athkatla, caerás! */
END COPY_TRANS SUJON 14

// Cadena cuando Dusk es Malvado
CHAIN P_DUSKJ P_DuskFall_IrenicusFinal_DuskLead_Evil
@10103443 /* Este es tan buen lugar como cualquiera para hacerte caer con nuestro poder, mago. El resultado será uno sólo: tu muerte. */
END COPY_TRANS SUJON 14
